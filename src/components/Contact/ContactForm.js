...
export default function ContactForm() {
  ...
  return (
    ...
    >
      I would love to connect with you to discuss how I can contribute in full-stack engineering, back-end engineering, AI engineering and other roles.  Find my resume on the About page.  Find my contact info below.
      {/* Name: {" "}
      <input
        type="text"
